...
class GameEngine {
    ...
    update_velocities(entity, keys_pressed) {
        ...
        entity.rotation_velocity = rotation_velocity_arr;
        ...
        var current_rotation = entity.rotations[2] + rotation_velocity; //pre-emptively add rotation velocity as it will be added in the next move()
        ...
        entity.position_velocity = position_velocity_arr
    }
